    ...
    <SiteLayout>
      <section className="relative isolate">
        ...
        <div className="mx-auto max-w-5xl px-4 py-24 text-center">
          <Reveal>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-pink">Services</p>
          </Reveal>
          <Reveal delay={0.1}>
            <h1 className="mt-4 text-5xl font-bold leading-[1.05] tracking-normal sm:text-7xl">
              Practical services for <span className="text-gradient-hero"><ScrambleText text="digital growth." /></span>
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              TechSquad combines software engineering, design, branding, and collaboration to build solutions that can serve real users.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24">
        <Reveal className="max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Process</p>
          <h2 className="mt-3 text-4xl font-bold tracking-normal sm:text-5xl"><ScrambleText text="How a project moves through TechSquad." /></h2>
        </Reveal>
